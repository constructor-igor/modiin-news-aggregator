...
//
//            var uriList = new List<Tuple<string, string, string>>();
//            //uriList.Add(new Tuple<string, string>("Rehovot - Modiin", uri_Rehovot_Modiin));
//            uriList.Add(new Tuple<string, string, string>("HaMada,Rehovot,Israel", "Modiin", uri_HaMadaRehovot_Modiin));   // http://goo.gl/lniEYK
//            uriList.Add(new Tuple<string, string, string>("Modiin", "Tel-Aviv", uri_Modiin_TelAviv));
//            uriList.Add(new Tuple<string, string, string>("Modiin", "Jerusalem", uri_Modiin_Jerusalem));
...
//                while (true)
//                {
//                    foreach (Tuple<string, string, string> uriItem in uriList)
//                    {
//                        string sourceAddress = uriItem.Item1;
//                        string destinationAddress = uriItem.Item2;
//                        string uri = uriItem.Item2;
//                        IProducer googleTrafficProducer = new LogDecoratorProducer(new UpdatesProducer(new GoogleTrafficProducer(sourceAddress, destinationAddress, new UriStreamCreator(uri))), includeEmptyMessage: false);
//                        queue.Enqueue(googleTrafficProducer.GetMessage());
//                    }
//                    Thread.Sleep(minutes5);
//                }
